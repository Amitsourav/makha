...
const PRODUCTS = {
  salt: {
    ...
    photos: { front: 'assets/salt-pouch.webp', jar: 'assets/salt-jar.webp', tin: 'assets/salt-tin.webp' },
    cardPhoto: 'assets/salt-pouch.webp',
  ...
  peri: {
    ...
    photos: { front: { src: 'assets/peri-pouch.webp', scene: true }, jar: { src: 'assets/peri-jar.webp', scene: true }, tin: { src: 'assets/peri-tin.webp', scene: true } },
    cardPhoto: 'assets/peri-pouch.webp',
  ...
  bbq: {
    ...
    photos: { front: { src: 'assets/bbq-pouch.webp', scene: true }, jar: 'assets/bbq-jar.webp', tin: { src: 'assets/bbq-tin.webp', scene: true } },
    cardPhoto: 'assets/bbq-pouch.webp',
  ...
  cheese: {
    ...
    photos: { front: { src: 'assets/cheese-pouch.webp', scene: true }, jar: { src: 'assets/cheese-jar.webp', scene: true }, tin: { src: 'assets/cheese-tin.webp', scene: true } },
    cardPhoto: 'assets/cheese-pouch.webp',
  ...
  choc: {
    ...
    photos: { front: { src: 'assets/choc-pouch.webp', scene: true }, jar: { src: 'assets/choc-jar.webp', scene: true }, tin: { src: 'assets/choc-tin.webp', scene: true } },
    cardPhoto: 'assets/choc-pouch.webp',
  ...
  truffle: {
    ...
    photos: { front: { src: 'assets/truffle-pouch.webp', scene: true }, jar: { src: 'assets/truffle-jar.webp', scene: true }, tin: { src: 'assets/truffle-tin.webp', scene: true } },
    cardPhoto: 'assets/truffle-pouch.webp',
